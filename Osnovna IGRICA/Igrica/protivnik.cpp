...
Protivnik ::Protivnik(SpriteSheet *sheet, int width, int height):Sprite(sheet,width,height)
{
...
void Protivnik :: draw(SDL_Renderer * renderer)
{
    if(state&LEFT)
    {
...
void  Protivnik::move(int dx, int dy)
{
    ...
    else if (spriteRect->y > 480 - spriteRect->h)
    {          //480 visina prozora
